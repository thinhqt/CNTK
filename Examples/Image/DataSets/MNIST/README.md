...
downloaded and converted to CNTK-supported format by running the following command:

`python mnist_convert.py`

After running the script, you will see two output files in the current folder: Train-28x28_cntk_text.txt and Test-28x28_cntk_text.txt. You may now go to the [`GettingStarted`](../../GettingStarted) folder to play with this dataset.
